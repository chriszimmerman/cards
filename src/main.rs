    ...
    egui::Window::new("Play Options").show(contexts.ctx_mut()?, |ui| {
        ...
        if ui.button("Hit").clicked() {
            ...
            commands.spawn((
                ...
                Transform::from_xyz(70. * state.player_hand.cards.len() as f32 - 660., 100., 0.),
                card.clone(),
            ));
        ...
        if timer.0.just_finished() {
            if state.cpu_score < 16 {
                ...
                commands.spawn((
                    ...
                    Transform::from_xyz(70. * state.cpu_hand.cards.len() as f32 - 660., 0., 0.),
                    card.clone(),
                ));
...
fn game_over(
    ...
    egui::Window::new(game_over_text)
